...
export default function Fastingdua({route,navigation}) {
   ...
   try {
    setLoading(true);
    const { sound } = await Audio.Sound.createAsync( { uri: 'https://firebasestorage.googleapis.com/v0/b/chat-3faa1.appspot.com/o/sehri.mp3?alt=media&token=47e2f706-d0fa-4e99-a488-d4413276824a' },
  )
   setSound(sound);
  setbtncolor("a")
  ...
  return ( 
    <SafeAreaView style={{top:0,backgroundColor:'white',flex:1,padding:0}}>
      <ImageBackground resizeMethod='resize'
       ...
       width:width, 
        ...
        source={require('../assets/fast/sehri.png')}
    ...
    <TouchableWithoutFeedback
                   ...
                   >
                    ...
                    {loading ? <ShowAlert/> : ""} 
                    {btncolor==='' ? <Image source={icons.speakers} style={{width: 30,left:185,top:50, height: 30 }} />:<Ionicons style={{
                                  left:185,top:50,
    ...
    {/* <TouchableOpacity
                        style={{ marginLeft: SIZES.base,flexDirection: 'row',paddingHorizontal: SIZES.radius,height:0,alignItems: 'flex-end',top:0,left:-40 }}
                    ...
                    <TouchableOpacity
                        style={{ marginLeft: SIZES.base,flexDirection: 'row',paddingHorizontal: SIZES.radius,height: 30,alignItems: 'flex-end',top:640,left:200 }}
                        onPress={() => navigation.navigate('Iftari')}
                    >
                    <Text style={{ ...FONTS.h2, color:'#00bff0',top:0,right:-28 }}>Iftar dua</Text>
                        <Image
                            source={icons.back_arrow_icon}
                            re
